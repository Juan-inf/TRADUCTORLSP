...
def main():
    ...
    print(f"Videos de evaluación WER (nunca vistos en entrenamiento — ni S31 ni S32): {videos_wer}")
    print("=" * 70)
    ...
    with open(DATA / "s32_wer_resultados.json", "w", encoding="utf-8") as f:
        json.dump({
