...
def main():
    ...
    resultados = {"s31": [], "s32": [], "s33": [], "s35": [], "produccion": []}
    ...
    for num in videos_wer:
        ...
        ref_s35 = secuencia_real(num, vocab_s35)
        hyp_s35 = secuencia_predicha_ventana_fija(num, sess_s35, i2l_s35, vocab_s35)
        w_s35 = wer(ref_s35, hyp_s35)
        print(f"  [S35] ref(vocab 275cls, n={len(ref_s35)}): {ref_s35[:12]}...")
        print(f"  [S35] hyp: {hyp_s35[:12]}...   WER={w_s35}")
    ...
    with open(DATA / "s35_bench_wer_resultados.json", "w", encoding="utf-8") as f:
        json.dump({
    ...
    print(f"\n✅ data/s35_bench_wer_resultados.json")
